...
1. Access statements in LCR under Reports > Financial Statements
2. Review all tabs: Donations, Balances, Fast Offering Analysis
3. Check for unusual transactions or duplicates
4. Address any action items
5. Mark each tab as reviewed
...
!!! tip "Recommendation for Financial Clerks"
