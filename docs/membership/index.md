...
!!! tip "LCR Support"
    For technical issues with Leader and Clerk Resources (LCR), contact the Global Services help desk through the LCR system or call the support number provided in your stake.

!!! info "Policy Questions"
    For policy questions about membership procedures, consult the Church Handbook Chapter 33 (Records and Reports) or contact your stake clerk.
...
- Financial Procedures (for donation recording that affects membership)

---

## Quick Links

- [Quarterly Reports](quarterly-reports.md) *(Coming Soon)*
- [Finding Lost Members](lost-members.md) *(Coming Soon)*
- [Membership Record Updates](#) *(Coming Soon)*
